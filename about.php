...
<body>
    <div class="mobile-menu">
        <ul class="mobile-menu-nav">
            ...
            <li class="mobile-menu-nav-item"><a href="" class="mobile-menu-link">Контрактное производство</a></li>
    ...
    <header class="header header-company">
        <div class="container">
            <div class="company-content">
                ...
                <h3 class="company-title">о компании</h3>
                <ul class="breadcrumb">
    ...
    <section class="section-about-swiper">
        <div class="container">
            <div class="swiper swiper-slider about-slider">
                <!-- обяз. обертка слайдера -->
                <ul class="swiper-wrapper header-features about-features">
                  ...
                  <li class="swiper-slide header-features-item">
                    ...
                    <p class="about-features-text">Контроль качества на всех этапах</p>
                  </li>
                  <li class="swiper-slide header-features-item">
                    <svg width="36" height="36">
    ...
    <section class="section founder about-founder">
    ...
    <section class="section blog">
        <div class="container">
            ...
            <div class="about-center">
                <p class="about-center-text">Явные признаки победы институционализации рассмотрены исключительно в разрезе маркетинговых и финансовых предпосылок. Приятно, граждане, наблюдать, как активно развивающиеся страны третьего мира могут быть ограничены исключительно образом мышления. Лишь независимые государства набирают популярность среди определенных слоев населения, а значит, должны быть указаны как претенденты на роль ключевых факторов. Лишь акционеры крупнейших компаний могут быть призваны к ответу.</p>
            ...
            <div class="swiper blog-slider">
                ...
                <div class="swiper-wrapper">
                  ...
                  <a href="#" class="swiper-slide blog-card">
                    <img src="img/blog/blog-photo.jpg" alt="" class="about-card-image">
                  </a>
                  <a href="#" class="swiper-slide blog-card">
                    <img src="img/blog/blog-photo-two.jpg" alt="" class="about-card-image">
                  </a>
                  <a href="#" class="swiper-slide blog-card">
                    <img src="img/blog/blog-photo.jpg" alt="" class="about-card-image">
                  </a>
                ...
                <div class="blog-slider-footer center-slider-footer">
